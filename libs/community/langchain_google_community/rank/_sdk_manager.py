...
class VertexRankSDKManager:
    def __init__(
        ...
        """
        Initializes the VertexRankSDKManager with the given project ID, location ID, and credentials.

        Args:
            project_id: The Google Cloud project ID.
            location_id: The location ID for the ranking service.
            credentials: The Google Cloud credentials object (optional).
            credentials_path: The path to the Google Cloud service account credentials file (optional).
        """
    ...
    def get_rank_service_client(self) -> discoveryengine_v1alpha.RankServiceClient:
        """
        Returns a RankServiceClient instance for making API calls to the Vertex AI Ranking service.

            ...
            "numeric_restricts": [
                {
                    ...
                    **({
                        ...
                        if hasattr(restrict, 'value_int') and restrict.value_int is not None
                        else restrict.value_float
                    } if hasattr(restrict, 'value_int') and restrict.value_int is not None else {

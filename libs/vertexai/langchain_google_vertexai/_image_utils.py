...
class ImageBytesLoader:
    ...
    def __init__(self, project: Union[str, None] = None,) -> None:
        """ Constructor
    ...
    def _bytes_from_b64(self, base64_image: str) -> bytes:
        ...
        raise ValueError(
            f"Error in b64 encoded image. Must follow pattern: {pattern}"
        )
    ...
    def _bytes_from_gsc(self, gcs_uri: str) -> bytes:
        ...
        blobs = list(
            gcs_client.list_blobs(pieces[2], prefix="/".join(pieces[3:])))

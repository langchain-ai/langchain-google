    ...
    *,
    ...
    info = {
        ...
        "safety_ratings": [
            ...
            # Image generation models sometime return ratings that are not included in the proto.
            for rating in candidate.safety_ratings if hasattr(rating.category, "name") 
        ],
        "citation_metadata": (
